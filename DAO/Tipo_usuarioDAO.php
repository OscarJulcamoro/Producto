...
class Tipo_usuarioDAO {
	public static function agregar($nuevo) {
		$cc=DB::getInstancia();
		$stSql = "INSERT INTO tipo_usuario (id_tipo_usuario,nombre_tipo) VALUES(:id_tipo_usuario,:nombre_tipo)";
	...
	public static function agregarAuto($nuevo) {
		$cc=DB::getInstancia();
		$stSql = "INSERT INTO tipo_usuario (nombre_tipo) VALUES(:nombre_tipo)";
		$rs = $cc->db->prepare($stSql);
	...
	public static function buscar($id) {
		...
		$ba = $rs->fetch();
		$nuevo = new Tipo_usuario($ba['id_tipo_usuario'],$ba['nombre_tipo']);
		return $nuevo; 
	}
	public static function actualizar($nuevo) {
		$cc=DB::getInstancia();
		$stSql = "UPDATE tipo_usuario SET nombre_tipo=:nombre_tipo WHERE id_tipo_usuario=:id_tipo_usuario";
		$rs = $cc->db->prepare($stSql);
		$params = self::getParams($nuevo);
		return $rs->execute($params);
	}
	...
	public static function getParams($nuevo){
		...
		$params['nombre_tipo'] = $nuevo->getNombre_tipo();
		return $params;
	}
